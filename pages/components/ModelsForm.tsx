...
const models = [
  { name: 'model1', style: 'realistic', popularity: 5, rating: 3.5, RUNS: 100 },
  { name: 'model2', style: 'anime', popularity: 7, rating: 4.5, RUNS: 200 },
  { name: 'model3', style: 'realistic', popularity: 10, rating: 5.0, RUNS: 300 },
];
